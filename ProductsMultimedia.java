...
public class ProductsMultimedia extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.products_media);
        ...
        // Список Категорий
        ArrayList<HashMap<String, Object>> productsMultimedia = new ArrayList<HashMap<String, Object>>();

// Список параметров конкретной категории
        HashMap<String, Object> product;

// Отправляем запрос в БД
        Cursor cursor = mDb.rawQuery("SELECT * FROM productsMultimedia;", null);
        cursor.moveToFirst();
...
// Пробегаем по всем категориям
        while (!cursor.isAfterLast()) {
            ...
            productsMultimedia.add(product);
...
// Создаем адаптер
        SimpleAdapter adapter = new SimpleAdapter(this, productsMultimedia, R.layout.adapter_item, from, to);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ProductsMultimedia.this, AnalogActivity.class);
