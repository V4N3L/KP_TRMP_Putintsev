...
public class ProductsVideo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.products_video);
        ...
        // Список Категорий
        ArrayList<HashMap<String, Object>> productsVideo = new ArrayList<HashMap<String, Object>>();

// Список параметров конкретной категории
        HashMap<String, Object> product;

// Отправляем запрос в БД
        Cursor cursor = mDb.rawQuery("SELECT * FROM productsVideo;", null);
        cursor.moveToFirst();
...
// Создаем адаптер
        SimpleAdapter adapter = new SimpleAdapter(this, productsVideo, R.layout.adapter_item, from, to);
        ListView listView = findViewById(R.id.lv_video);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ProductsVideo.this, AnalogActivity.class);
